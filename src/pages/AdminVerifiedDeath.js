...
const statusBodyTemplate2 = (rowData) => {
    return <Link  className={`btn btn-primary text-primary font-bold`} to={`/singleDeath/${rowData.id}`} >
VIEW 
    </Link>
}
  ...
  return (
    ...
    {/* <div className='grid mt-2'> */}
     <div className="col-12 lg:col-12">
        ...
        <span className="text-xl font-medium text-900">Pending Registration List</span>
            ...
            //  ref={dt}
                    ...
                    //  currentPageReportTemplate="Showing {first} to {last} of {totalRecords}" rows={5} rowsPerPageOptions={[5,10,50]}
                        ...
                        {/* <Column field="id" header="Device Id"></Column> */}
                            <Column field="deceased_firstname" header="first Name"></Column>
                            <Column field="deceased_surname" header="surname"></Column>
                            <Column field="deceased_middlename" header="middlename"></Column>
