...
const dt = useRef(null);
  ...
  return (
    ...
    <div className="col-12 " style={{backgroundColor:'#7806B8'}}>
        <p className='text-white m-0 text-sm font-bold'>Total Birth Registration Modifications:62,546</p>
        </div>
                  ...
                  filters={filters1}
                    ...
                    stripedRows
                     ...
                     currentPageReportTemplate="Showing {first} to {last} of {totalRecords}" rows={5} rowsPerPageOptions={[5,10,50]}
                        ...
                        <Column field="email" header="Certificate Number"></Column>
                            <Column field="username" header="Surname of Applicant"></Column>
                            <Column field="name" header="First Name of Applicant"></Column>
                            <Column field="phone" header="Middle Name of Applicant"></Column>
