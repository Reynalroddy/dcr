...
import {getModAttestRegz} from "../redux/apiCalls"
import authFetch from '../axios';
// import Filter from '../components/Filter';
// import jsPDF from 'jspdf';
// import { Tooltip } from 'primereact/tooltip';
import { Dropdown } from 'primereact/dropdown';
import { handleChange,clearFilters } from '../redux/modAttestSlice';
const ModifyAttest = () => {
...
useEffect(() => {
  const getStatz=async()=>{
      try {
          const statistics = await authFetch.get('https://npc-cert.verxid.site/v0/state-director/modification/birth-attestation/stats');
...
useEffect(() => {
  getModAttestRegz(dispatch, search,
          result_per_page,
          page,
          type
         )
