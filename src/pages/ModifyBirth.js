...
import {getModBirthRegz} from "../redux/apiCalls"
import authFetch from '../axios';
// import Filter from '../components/Filter';
// import jsPDF from 'jspdf';
// import { Tooltip } from 'primereact/tooltip';
import { handleChange,clearFilters } from '../redux/modRegSlice';
...
useEffect(() => {
  ...
  const getStatz=async()=>{
      ...
      try {
          const statistics = await authFetch.get('https://npc-cert.verxid.site/v0/state-director/modification/birth-registration/stats');
...
useEffect(() => {
  getModBirthRegz(dispatch, search,
          result_per_page,
          page,
          type
         )
...
const statusBodyTemplate2 = (rowData) => {
  return <Link  className={`btn btn-primary text-primary font-bold`} to={`/single-birth/${rowData.Birth_Reg_ID}`} >
VIEW 
  </Link>
}
                    ...
                    stripedRows
                     ...
                     currentPageReportTemplate="Showing {first} to {last} of {totalRecords}" rows={5} rowsPerPageOptions={[5,10,50]}
                        ...
                        <Column field="FirstName" header="firstname"></Column>
                            ...
                            <Column field="Date_Registerred" header="Date created"></Column>
