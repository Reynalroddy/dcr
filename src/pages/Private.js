...
useEffect(() => {
  ...
  const getStatz=async()=>{
      ...
      try {
          const statistics = await authFetch.get('https://npc-cert.verxid.site/v0/state-director/birth-attestation/stats');
...
const dt = useRef(null);
  ...
  return (
    ...
    <div className="col-12 " style={{backgroundColor:'#10A6AB'}}>
        <p className='text-white m-0 text-sm font-bold'>Total Attestation Registrations:{rez?.total}</p>
        </div>
