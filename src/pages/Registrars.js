...
<span className='text-md uppercase font-bold'>ABIA</span>
{/* icon */}
...
<span className='text-xs bg-green-500 text-white px-2 py-2 '>65</span>
{/* <img  src={nc} style={{width:'3rem',height:'3rem'}} alt=''/> */}
<Link to={`/registrars-list/id`}>
...
<div className="flex flex-column align-items-center  gap-2 surface-card shadow-2 border-round p-3">
<img  src={Logo} style={{width:'3rem',height:'3rem'}} alt=''/>
<span className='text-md uppercase font-bold'>OYO</span>
{/* icon */}
<div className='flex gap-2 justify-content-center'>
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-1 h-1">
  <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
...
<span className='text-xs bg-green-500 text-white px-2 py-2 '>200</span>
{/* <img  src={nc} style={{width:'3rem',height:'3rem'}} alt=''/> */}
...
<span className='text-xs bg-green-500 text-white px-2 py-2 '>100</span>
{/* <img  src={nc} style={{width:'3rem',height:'3rem'}} alt=''/> */}
<Link to={`/birth/state/:id`}>
<span className='text-green-500 text-xs font-bold'>view Registrars</span>
</Link>
...
<div className="flex flex-column align-items-center  gap-2 surface-card shadow-2 border-round p-3">
<img  src={Logo} style={{width:'3rem',height:'3rem'}} alt=''/>
<span className='text-md uppercase font-bold'>ANAMBRA</span>
{/* icon */}
<div className='flex gap-2 justify-content-center'>
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-1 h-1">
  <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
...
<span className='text-xs bg-green-500 text-white px-2 py-2 '>50</span>
{/* <img  src={nc} style={{width:'3rem',height:'3rem'}} alt=''/> */}
<Link to={`/birth/state/:id`}>
<span className='text-green-500 text-xs font-bold'>view Registrars</span>
</Link>
